...
DROP TABLE IF EXISTS tbl_FornecedoresTipoServicos;
...
CREATE TABLE tbl_Carros (
	cdCarro INT PRIMARY KEY, -- Fica
	placaCarro VARCHAR(20) UNIQUE, -- Fica
	corCarro VARCHAR(30), -- Fica
	nomeModelo VARCHAR(50) NOT NULL, -- Sair
	nomeFabricante VARCHAR(50) NOT NULL, -- Sair
	anoModelo INT NOT NULL, -- Sair
	cdCliente INT NOT NULL -- Fica
);
...
REFERENCES tbl_TipoVeiculos (tbl_TipoVeiculos)
